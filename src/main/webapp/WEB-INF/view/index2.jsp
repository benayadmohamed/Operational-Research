	...
	linksTable.addRow([arrets2[i].depart.id, arrets2[i].arrive.id,arrets2[i].longueur, color, len,'arrow-end']);
     ...
     function CalculePcc(){
        ...
        // $('#selectDepart').prop('disabled', 'disabled');
         ...
         $.post("/ProjectRo/CalculePccBelmman", { idG:vidG,idS:vdepart } )
         .done(function( data ) {
         	//console.log(  data );
     ...
     function CalculePlc(){
         ...
         // $('#selectDepart').prop('disabled', 'disabled');
          ...
          $.post("/ProjectRo/CalculePlcBelmman", { idG:vidG,idS:vdepart } )
          .done(function( data ) {
          	//console.log(  data );
          	//data=JSON.parse(data);
          	//data=data.sommets;
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Algorithme de Bellman <small>.</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="#"><i class="fa fa-dashboard"></i>Algorithme de Bellman</a></li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title"> Algorithme de Bellman </h3>
								</div>
